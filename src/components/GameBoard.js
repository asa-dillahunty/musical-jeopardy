...
export function PlayCard({
          ...
          {selectedPlayer && (
            <>
              <NumberInput
                ...
                incPerDigit
              />
              <button onClick={finalizeWager} className="finalize-wager-button">
                Finalize Wager
              </button>
            </>
          )}
  ...
  const nameOfClass = isDailyDouble
    ? "selected-card daily-double"
    : "selected-card";
  return (
    <div className={nameOfClass}>
      <div className="question-box">
          ...
          <div className={`answer-box ${isAnswerVisible ? "" : "hidden"}`}>
            ...
            {isDailyDouble && (
              <div className="result-button-box">
                <button className="failure" onClick={loseWager}>
                  <FaXmark />
                </button>
                <button className="success" onClick={winWager}>
                  <FaCheck />
                </button>
              </div>
            )}
        ...
        {!isAnswerVisible && (
          <FaEyeSlash className="reveal-button" onClick={showAnswer} />
        )}
        <AiFillCloseCircle
          className="close-button"
          onClick={() => setSelectedCard({})}
...
function BoardValueNumberInputs({
  cols,
  setCols,
  rows,
  setRows,
      ...
      <div className="game-board-and-sidebar">
        ...
        {!editing && (
          <PlayerContainer
            ...
            onClickPlayer={
              selectedIsDailyDouble ? setSelectedPlayer : onClickPlayer
            }
